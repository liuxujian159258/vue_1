<template>
    <div>
      ...
      <el-card>
        ...
        <!-- 分页 -->
        <el-pagination @size-change="handleSizeChangeCate"
                       @current-change="handleCurrentChangeCate" :current-page="queryInfo.pagenum"
    ...
    <el-button @click="addCatDialogClosed">取 消</el-button>
...
export default {
  ...
  methods: {
    ...
    // 监听pagesize改变
    handleSizeChangeCate (newPageSize) {
      this.queryInfo.pagesize = newPageSize
      this.getCateList()
    },
    // 监听pagenum改变
    handleCurrentChangeCate (newPageNum) {
